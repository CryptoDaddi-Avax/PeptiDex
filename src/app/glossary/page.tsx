        ...
        <div className="max-w-2xl mx-auto px-3 py-4 md:px-4 md:py-6">
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <h1 className="text-xl md:text-2xl font-bold text-zinc-100">Peptide Glossary</h1>
                </div>
                <p className="text-xs md:text-sm text-zinc-400">{glossary.length} terms · Every concept explained in plain English</p>
            </motion.div>
