      ...
      <header className="page-header">
        ...
        <div className="page-header-wrap">
          <nav className="breadcrumb">
            ...
            <span className="sep">/</span>
            <span className="current">The Oral Peptide Revolution Has Arrived</span>
          </nav>
          <div className="section-label">§ Blog Article</div>
          <h1 className="page-title">
            The Oral Peptide Revolution<br /><em>Has Arrived</em>.
          </h1>
          <p className="page-subtitle">
            An independent analysis of the recent FDA approvals for oral GLP-1 and small-molecule peptide therapeutics, and what they mean for the future of longevity and weight loss.
          </p>
