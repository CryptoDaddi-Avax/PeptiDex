...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: POST_DESC,
    url: 'https://peptidex.app/blog/are-peptides-safe',
    type: 'article',
    images: [{
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 md:py-12 relative space-y-12">
      ...
      <header className="space-y-6">
        ...
        <ShareBar title={POST_TITLE} url={`https://peptidex.app/blog/are-peptides-safe`} />
      </header>
      ...
      {/* Citations */}
      <div className="mb-12">
        <CiteThisPage title={POST_TITLE} url={`https://peptidex.app/blog/are-peptides-safe`} />
      </div>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-zinc-800/50 text-xs text-zinc-600">
        ...
        <FeedbackModal pageUrl="https://peptidex.app/blog/are-peptides-safe" />
      </div>
