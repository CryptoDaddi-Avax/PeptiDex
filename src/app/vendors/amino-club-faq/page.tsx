...
const faqs = [
  ...
  { q: 'What purity standard does Amino Club maintain?', a: 'Their baseline standard is â‰¥99% purity as verified by HPLC. Many of their batches test at 99.5% or higher.' },
  ...
  { q: 'How should I store peptides purchased from Amino Club?', a: 'Lyophilized (freeze-dried) powder should be stored in a freezer away from light. Once reconstituted with BAC water, they must be stored in a refrigerator (usually between 36Â°F and 46Â°F).' },
    ...
    <main id="main-content">
      ...
      <header className="page-header">
        ...
        <div className="page-header-wrap">
          ...
          <div className="section-label">Â§ Knowledge Base</div>
          <h1 className="page-title">
            Amino Club<br /><em>frequently asked</em>.
          </h1>
          <p className="page-subtitle">
            Shipping logistics, analytical testing protocols, and applying our exclusive discount code â€” all answered.
          </p>
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="rounded-xl border border-zinc-800 bg-zinc-900/30 p-6">
                <h3 className="font-bold text-zinc-100 mb-3 flex items-start gap-3">
                  <span className="text-xs font-bold text-emerald-400 font-mono flex-shrink-0 mt-1">Â§ {String(i + 1).padStart(2, '0')}</span>
                  {faq.q}
                </h3>
