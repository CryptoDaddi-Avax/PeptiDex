/**
 * Onboarding Guide — Data & Configuration
 * =========================================
...
export const SUPPLY_PRODUCTS: SupplyProduct[] = [
  ...
  },
  {
    ...
    description: '22G–25G luer-lock syringes for transferring BAC water into vials. These are for mixing only — never used for injection.',
  ...
  },
  {
    ...
    description: 'Sterile 70% isopropyl alcohol wipes. Swab every rubber stopper and every injection site, every time — no exceptions.',
...
export const STEPS: StepMeta[] = [
  ...
  { number: 3, title: 'How to Reconstitute', subtitle: 'Turn powder into injectable solution — safely', gaKey: 'reconstitution' },
...
// ── Reconstitution steps (reused from beginners-guide) ────────────────────────
export const RECON_STEPS = [
  ...
  { step: '5', title: 'Inject Down the Glass', desc: 'Insert the needle into the peptide vial at an angle so the water trickles down the glass wall. Slow and steady — never force it.' },
  { step: '6', title: 'Roll, Never Shake', desc: 'Gently roll the vial between your palms for 60–90 seconds. The powder should dissolve clear within minutes. If cloudy after 20 minutes, the peptide may be degraded — do not use.' },
];

// ── Toolkit cross-sell items ──────────────────────────────────────────────────
