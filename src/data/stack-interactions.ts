...
export const stackInteractions: StackInteraction[] = [
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Semenova et al., 2010 — Bull Exp Biol Med (Selank anxiolytic)", url: "https://pubmed.ncbi.nlm.nih.gov/20821102/" },
      { type: "pubmed", label: "Dolotov et al., 2006 — J Mol Neurosci (Semax BDNF)", url: "https://pubmed.ncbi.nlm.nih.gov/16691011/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Sikiric et al., 2016 — Curr Neuropharmacol (BPC-157 CNS)", url: "https://pubmed.ncbi.nlm.nih.gov/26646071/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Hancock et al., 2016 — Nat Rev Drug Discov (LL-37 immune)", url: "https://pubmed.ncbi.nlm.nih.gov/26876839/" },
      { type: "pubmed", label: "Goldstein et al., 2012 — Sci Transl Med (Thymosin Alpha-1)", url: "https://pubmed.ncbi.nlm.nih.gov/22993295/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Sikiric et al., 2020 — Curr Med Chem (BPC-157 anti-inflammatory)", url: "https://pubmed.ncbi.nlm.nih.gov/30672399/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Schoenenberger et al., 1983 — Eur J Biochem (DSIP)", url: "https://pubmed.ncbi.nlm.nih.gov/6347077/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Khavinson et al., 2002 — Bull Exp Biol Med (Epitalon circadian)", url: "https://pubmed.ncbi.nlm.nih.gov/12500373/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Raun et al., 1998 — Eur J Endocrinol (Ipamorelin selectivity)", url: "https://pubmed.ncbi.nlm.nih.gov/9834455/" },
      { type: "pubmed", label: "Bowers et al., 1994 — J Clin Endocrinol Metab (GHRP-6)", url: "https://pubmed.ncbi.nlm.nih.gov/7962280/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Arvat et al., 1997 — J Clin Endocrinol Metab (GHRP-2 cortisol)", url: "https://pubmed.ncbi.nlm.nih.gov/9048576/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Ghigo et al., 1994 — J Endocrinol Invest (Hexarelin)", url: "https://pubmed.ncbi.nlm.nih.gov/8006876/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Bowers et al., 1994 — J Clin Endocrinol Metab (GHRP-6 + GHRH)", url: "https://pubmed.ncbi.nlm.nih.gov/7962280/" },
...

  {
    ...
    citations: [
      ...
      { type: "pubmed", label: "Diamond et al., 2004 — J Sex Med (PT-141)", url: "https://pubmed.ncbi.nlm.nih.gov/16422884/" },
...

  {
    ...
    citations: [
      ...
      { type: "pubmed", label: "Goldstein & Goldstein, 2009 — Ann NY Acad Sci (Thymosin Alpha-1)", url: "https://pubmed.ncbi.nlm.nih.gov/19758152/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Bhatt et al., 2017 — J Am Heart Assoc (SS-31 mitochondria)", url: "https://pubmed.ncbi.nlm.nih.gov/28974517/" },
      { type: "pubmed", label: "Pickart & Margolina, 2018 — Biomolecules (GHK-Cu)", url: "https://pubmed.ncbi.nlm.nih.gov/29937537/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Heffernan et al., 2001 — J Endocrinol (AOD-9604 lipolysis)", url: "https://pubmed.ncbi.nlm.nih.gov/11457449/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Heffernan et al., 2001 — J Endocrinol (AOD-9604)", url: "https://pubmed.ncbi.nlm.nih.gov/11457449/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Guler et al., 1988 — NEJM (IGF-1 glucose effects)", url: "https://pubmed.ncbi.nlm.nih.gov/2839616/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Chapman et al., 1997 — J Clin Endocrinol Metab (MK-677)", url: "https://pubmed.ncbi.nlm.nih.gov/9215304/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Goldstein et al., 2012 — Sci Transl Med (Thymosin Alpha-1 immune)", url: "https://pubmed.ncbi.nlm.nih.gov/22993295/" },
...

  {
    ...
    citations: [
      { type: "pubmed", label: "Bowers et al., 1994 — JCEM (GHRP-6)", url: "https://pubmed.ncbi.nlm.nih.gov/7962280/" },
      { type: "pubmed", label: "Arvat et al., 1997 — JCEM (GHRP-2)", url: "https://pubmed.ncbi.nlm.nih.gov/9048576/" },
